...
void InLvColoredThreeTriangleFigure::initialize() 
{
	...
	glm::vec4 c0 = glm::vec4(0.0f, 1.0f, 1.0f, 1.0f);
	glm::vec4 c1 = glm::vec4(1.0f, 0.0f, 0.0f, 1.0f);
	glm::vec4 c2 = glm::vec4(0.0f, 1.0f, 0.0f, 1.0f);
	glm::vec4 c3 = glm::vec4(0.0f, 0.0f, 1.0f, 1.0f);

	vector<VertexData> v;
	v.push_back( VertexData( v0, c1 ) );
	v.push_back( VertexData( v1, c1 ) );
	v.push_back( VertexData( v2, c1 ) );
	v.push_back( VertexData( v3, c2 ) );
	v.push_back( VertexData( v4, c2 ) );
	v.push_back( VertexData( v5, c2 ) );
