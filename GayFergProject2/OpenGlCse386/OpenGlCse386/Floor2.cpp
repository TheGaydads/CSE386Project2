...
void Floor2::setShaderValues()
{
	...
	darkMaterial.setAmbientAndDiffuseMat( vec4( 0.0f, 1.0f, 0.0f, 1.0f ) );
	darkMaterial.setSpecularMat( vec4(0.0f, 1.0f, 0.0f, 1.0f) );
	...
	lightMaterial.setAmbientAndDiffuseMat( vec4( 0.0f, 1.0f, 0.0f, 1.0f ) );
	lightMaterial.setSpecularMat( vec4(0.0f, 1.0f, 0.0f, 1.0f) );
